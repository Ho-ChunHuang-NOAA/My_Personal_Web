...
#
   ...
   sed -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!VERIFAODIMAGE!${WebFig}/${Y0}/${YM}/FULL_CMAQ_AOD_CSI_DAY1_06Z_HIGH_${YM}.png!" ${local_base}/mytest.base > ${working_dir}/mytest.html
