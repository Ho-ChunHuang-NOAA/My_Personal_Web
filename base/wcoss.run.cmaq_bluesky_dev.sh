...
if [ 1 -eq 1 ]; then
   ...
   sed -e "s!=\"${D0}\"  > ${D0}!=\"${D0}\"  selected > ${D0}!" -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!HYSPLITPRODIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/cmaqconussmokepbl_03.gif!"  -e "s!HYSPLITDEVIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/cmaqconussmokepbl_03_dev.gif!" -e "s!NESDISIMAGE!${WebFig}/${Y0}/${TODAY}/nesdisconussmokepbl_11.gif!" -e "s!FIRE1IMAGE!${WebFig}/${Y0}/${TODAY}/t06z/cmaqhmsfire.conus.prod.${TODAY}.t06z.location.day1.k1.png!" -e "s!FIRE2IMAGE!${WebFig}/${Y0}/${TODAY}/t06z/cmaqhmsfire.conus.dev.${TODAY}.t06z.location.day1.k1.png!" ${local_base}/cmaq_bluesky_${version}.base > ${local_html}/cmaq_bluesky.html
...
scp ${local_html}/cmaq_bluesky.html ${remote_user}@${remote_machine}:${remote_html}
...
scp ${local_js}/cmaq_bluesky_${version}.js ${remote_user}@${remote_machine}:${remote_js}/cmaq_bluesky.js
exit
