...
## if [[ -e ${remote_fig}/${Y0}/${TODAY}/hysplitconussmokepbl_03.png ]]; then
   ...
   sed -e "s!=\"${D0}\"  > ${D0}!=\"${D0}\"  selected > ${D0}!" -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!CMAQO3IMAGE1!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp1}.${TODAY}.t06z.21.o3.k1.png!"  -e "s!CMAQO3IMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp2}.${TODAY}.t06z.21.o3.k1.png!" -e "s!CMAQO3IMAGE3!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp3}.${TODAY}.t06z.21.o3.k1.png!" -e "s!FIREIMAGE3!${WebFig}/${Y0}/${TODAY}/t06z/gbbepxfire.conus.prod.${TODAY}.t06z.location.day0.k1.png!" -e "s!FIREIMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/fireemisfire.conus.para6d.${TODAY}.t06z.location.day0.k1.png!" -e "s!FIREIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/rrfs_fireemisfire.conus.v70a1.${TODAY}.t06z.location.06.k1.png!" ${local_base}/rrfs_cmaq_o3_test.base > ${working_dir}/rrfs_cmaq_o3_test.html
##   sed -e "s!=\"${D0}\"  > ${D0}!=\"${D0}\"  selected > ${D0}!" -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!CMAQO3IMAGE!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp}.${TODAY}.t06z.max_1hr_o3.day1.k1.png!"  -e "    s!CMAQO3IMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp2}.${TODAY}.t06z.max_1hr_o3.day1.k1.png!" -e "s!FIREIMAGE3!${WebFig}/${Y0}/${TODAY}/t06z/gbbepxfire.conus.prod.${TODAY}.t06z.location.day0.k1.png!" -e "s!FIREIMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/fireemisfire.conus.para6d.${TODAY}.t06z.location.day0.k1.png!" -e "s!FIREIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/rrfs_fireemisfire.conus.v70a1.${TODAY}.t06z.location.06.k1.png!" ${local_base}/cmaq_o3_max.base > ${working_dir}/cmaq_o3_max.html
...
cp -p ${local_js}/rrfs_cmaq_o3_test.js .
