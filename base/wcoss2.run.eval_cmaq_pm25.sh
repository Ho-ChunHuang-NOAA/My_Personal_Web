...
exp4=v70c55bcobs
   ...
   ##
   sed -e "s!AAAA!${Y0}!" -e "s!BBBB!${Mx}!" -e "s!CCCC!${D0}!"  -e "s!XXXX!${FstY0}!" -e "s!YYYY!${FstMx}!" -e "s!ZZZZ!${FstD0}!" ${local_js}/cmaq_pm_latest.day.js.base > ${working_dir}/eval_pm_latest.day.js

cp -p ${local_js}/eval_cmaq_pm25.js .
cp -p ${local_js}/eval_cmaq_pm25_max.js .
## cp -p ${local_js}/eval_cmaq_pm25_nog16.js .
