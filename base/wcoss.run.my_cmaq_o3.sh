...
## if [[ -e ${remote_fig}/${Y0}/${TODAY}/hysplitconussmokepbl_03.gif ]]; then
   ...
   sed -e "s!=\"${D0}\"  > ${D0}!=\"${D0}\"  selected > ${D0}!" -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!CMAQPMIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp}.${TODAY}.t06z.21.o3.k1.gif!"  -e "    s!CMAQPMIMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp2}.${TODAY}.t06z.21.o3.k1.gif!"  -e "s!FIREIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/hmsfire.conus.prod.${TODAY}.t06z.location.day1.k1.png!" -e "s!FIREIMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/gbbepxfire.conus.para6.${TODAY}.t06z.location.day1.k1.png!" ${local_base}/my_cmaq_o3.base > ${working_dir}/my_cmaq_o3.html
   sed -e "s!=\"${D0}\"  > ${D0}!=\"${D0}\"  selected > ${D0}!" -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!CMAQPMIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp}.${TODAY}.t06z.max_1hr_o3.day1.k1.gif!"  -e "    s!CMAQPMIMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/aqm.conus.${exp2}.${TODAY}.t06z.max_1hr_o3.day1.k1.gif!"  -e "s!FIREIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/hmsfire.conus.prod.${TODAY}.t06z.location.day1.k1.png!" -e "s!FIREIMAGE2!${WebFig}/${Y0}/${TODAY}/t06z/gbbepxfire.conus.para6.${TODAY}.t06z.location.day1.k1.png!" ${local_base}/my_cmaq_o3_max.base > ${working_dir}/my_cmaq_o3_max.html
