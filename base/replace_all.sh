...
old_ver='${COMROOTp2}'
new_ver='${COMROOT}'
old_ver='\/gpfs\/dell2\/emc\/verification\/save\/${USER}\/WEB\/base'
new_ver='\/gpfs\/dell2\/emc\/modeling\/save\/${USER}\/WEB\/base'
old_ver='\/gpfs\/dell2\/emc\/verification\/noscrub\/${USER}\/WEB'
