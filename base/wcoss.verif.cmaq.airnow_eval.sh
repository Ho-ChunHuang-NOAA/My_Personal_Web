...
CASE_ID=CMAQV5P6
   ...
   sed -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!VERIFAIRNOWIMAGE!${WebFig}/${Y0}/${YM}/CONUS_${CASE_ID}_AIRNOW_O3_TIME_SERIES_DAY1_06Z_${YM}.png!" ${local_base}/verif_cmaq_airnow_eval.base > ${working_dir}/verif_cmaq_airnow_eval.html
...
cp -p ${local_js}/verif_cmaq_airnow_eval.js .
