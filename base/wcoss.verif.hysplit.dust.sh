...
#
   ...
   sed -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!VERIFDUSTIMAGE!${WebFig}/${Y0}/${YM}/FULL_HYSPLIT_DUST_CSI_DAY1_06Z_${YM}.png!" ${local_base}/verif_hysplit_dust.base > ${working_dir}/verif_hysplit_dust.html
...
cp -p ${local_js}/verif_hysplit_dust.js .
chmod 755 *
