...
#
   ...
   sed -e "s!=\"${D0}\"  > ${D0}!=\"${D0}\"  selected > ${D0}!" -e "s! > ${chrstr}! selected > ${chrstr}!" -e "s! > ${Y0}! selected > ${Y0}!"  -e "s!HYSPLITPRODIMAGE!${WebFig}/${Y0}/${TODAY}/t06z/hysplitconussmokepbl_21_prod.png!" -e "s!FIRE1IMAGE!${WebFig}/${Y0}/${TODAY}/t06z/hmsfire.conus.prod.${TODAY}.t06z.location.day1.k1.png!" -e "s!HIGHGAOD!${WebFig}/${Y0}/${TODAY}/hysplit.conus.g16.${TODAY}.21.aod.high.png!"  -e "s!MEDGAOD!${WebFig}/${Y0}/${TODAY}/hysplit.conus.g16.${TODAY}.21.aod.medium.png!"  -e "s!HIGHVAOD!${WebFig}/${Y0}/${TODAY}/hysplit.conus.viirs.${TODAY}.21.smkaod.high.png!" -e "s!MEDVAOD!${WebFig}/${Y0}/${TODAY}/hysplit.conus.viirs.${TODAY}.21.smkaod.medium.png!" ${local_base}/hysplit_bluesky.base > ${working_dir}/hysplit_bluesky.html
...
cp -p ${local_js}/hysplit_bluesky.js .
