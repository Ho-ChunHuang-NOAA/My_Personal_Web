...
function show2(i){
   ...
   document.cmaq4_pm_image.src =  pics[latest_ith+3*nmodel].src;
}
   ...
   if ( flag_continue == "yes" ) {
     if ( day > mcday ) {
        ...
        if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
           ...
           for (k=1; k<=nmodel; k++) {
              data=Num2Chr(k);
              filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp4+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
              preload(filename);
           }
      ...
      alert("Please select date in 2020/09, 2022/07, 2022/08, 2022/12, 2023/01, and 2023/03");
   }
}
...
function load_image_latest(){
   ...
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp4+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
      preload(filename);
   }
   show(0);
...
function load_imageP1(frm){
   ...
   if ( new_yr == "2023" && new_mon == "01" ) {
       flag_continue="yes";
   }
   if ( new_yr == "2023" && new_mon == "03" ) {
       flag_continue="yes";
   }
   if ( flag_continue == "yes" ) {
   if ( new_day > mcday ) {
     ...
     show(0);
      ...
      alert("The next day should remain in 2020/09, 2022/07, 2022/08, 2022/12, 2023/01, or 2023/03");
   }
}
function load_imageM1(frm){
   ...
   if ( flag_continue == "yes" ) {
     ...
     show(0);
      ...
      alert("The day before should remain in 2020/09, 2022/07, 2022/08, 2022/12, 2023/01, or 2023/03");
   }
}
