...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_ncopara.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_ncoparamprod.png";
            preload(filename);
         }
...
function load_image_latest(){
   ...
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_ncopara.png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_ncoparamprod.png";
      preload(filename);
   }
   show(11);
...
function load_imageP1(frm){
   ...
   if ( new_day > mcday ) {
      ...
      if ( new_julian_day < first_julian_day || new_julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+frm.ptyp.options[frm.ptyp.selectedIndex].value+data+"_ncopara.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+frm.ptyp.options[frm.ptyp.selectedIndex].value+data+"_ncoparamprod.png";
            preload(filename);
         }
         istatus=save_current_date(chr_yr,chr_mon,chr_day);
         istatus=save_current_prod(cycle,area,prod,layer);
