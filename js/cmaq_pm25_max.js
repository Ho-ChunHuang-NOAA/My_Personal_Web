...
function save_current_prod(exp,emcexp,cycle,area,prod) {
   current_exp=exp;
...
function show2(i){
   ...
   document.cmaq_pm_image.src  =  pics[latest_ith].src;
...
function prev(){
   ith=ith-1;
   if(ith < 0) ith=0;
   document.cmaq_pm_image.src  =  pics[ithth].src;
   document.cmaq2_pm_image.src =  pics[ith+nmodel].src;
   document.cmaq3_pm_image.src =  pics[ith+2*nmodel].src;
   document.fire1_image.src    =  pics[ith+3*nmodel].src;
   document.fire2_image.src    =  pics[ith+4*nmodel].src;
...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         prod2=prod;
         if ( julian_day < switch_day ) {
            if ( prod2 == "max_1hr_pm25" ) {
               prod="1hpm25-max";
            }
            if ( prod2 == "ave_24hr_pm25" ) {
               prod="24hpm25-ave";
            }
         }
         fireexp1=exp;
         fireexp2=emcexp;
         femcexp_fire="gbbepxfire";
         if ( exp != "prod" &&  exp != "ncopara" && exp != "para6d" ) {
            fexp_fire="fireemisfire";
         }
         if ( exp == "prodbc" || exp == "para6d" ) {
            fireexp1="prod";
         }
         if ( exp == "ncopara" ) {
            fireexp1="prod";
         ...
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"."+dateStr+".t"+cycle+"z."+prod2+".day"+k+".k1.png";
            preload(filename);
         }
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"-"+exp+"."+dateStr+".t"+cycle+"z."+prod2+".day"+k+".k1.png";
            preload(filename);
         }
         for (k=1; k<=nmodel; k++) {
         ...
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/dustemis."+area+"."+exp+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/dustemis."+area+"."+femcexp_dust+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
...
function load_image_latest(){
   ...
   prod2=prod;
   if ( latest_julian_day < switch_day ) {
      if ( prod2 == "max_1hr_pm25" ) {
         prod="1hpm25-max";
      }
      if ( prod2 == "ave_24hr_pm25" ) {
   ...
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"."+dateStr+".t"+cycle+"z."+prod2+".day"+k+".k1.png";
      preload(filename);
   }
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"-"+exp+"."+dateStr+".t"+cycle+"z."+prod2+".day"+k+".k1.png";
      preload(filename);
   }
   for (k=1; k<=nmodel; k++) {
   ...
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/dustemis."+area+"."+exp+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
      preload(filename);
   }
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/dustemis."+area+"."+femcexp_dust+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
      preload(filename);
   }
   show(0);
