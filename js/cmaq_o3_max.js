...
function anim(){
   ...
   document.fire3_image.src    =  pics[i+3*nmodel+2].src;
...
function show2(i){
   ...
   document.cmaq_o3_image.src  =  pics[latest_ith].src;
   ...
   document.fire3_image.src    =  pics[latest_iti+3*nmodel+2].src;
}
...
function show(i){
   ...
   document.fire3_image.src    =  pics[ith+3*nmodel+2].src;
}
