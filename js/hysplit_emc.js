...
function anim(){
     ...
     document.highvaod_image.src =  pics[i+3*nmodel].src;
     document.medvaod_image.src =  pics[i+4*nmodel].src;
     if (i<=24){
        document.hms1_image.src  =  pics[5*nmodel].src;
     }
     else {
        document.hms1_image.src  =  pics[5*nmodel+1].src;
     }
     if (i<=24){
        document.hms2_image.src  =  pics[5*nmodel+2].src;
     }
     else {
        document.hms2_image.src  =  pics[5*nmodel+3].src;
     }
...
function show2(i){
   ...
   document.highvaod_image.src =  pics[ith+3*nmodel].src;
   document.medvaod_image.src =  pics[ith+4*nmodel].src;
   if (ith<=24){
      document.hms1_image.src  =  pics[5*nmodel].src;
   }
   else {
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".viirs."+newdate+"."+data+"."+viirstype+".high.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".viirs."+newdate+"."+data+"."+viirstype+".medium.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
