...
function save_current_prod(area,qc) {
   current_area=area;
   current_qc=qc;
   return 0;
}

function get_current_qc(){
   var j=current_qc;
   return j;
}
...
function myWin(){
    newWin = open ("http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/html/abiaod2_png.html", "displayWindow", "width=950,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function myWindow(frm){
    ...
    newWin = open ("http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/html/abiaod2_png.html", "displayWindow", "width=800,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function anim(){
   ...
   document.abiaod1_image.src =  pics[i].src;
   document.abiaod2_image.src =  pics[i+nmodel].src;
   document.abiaod3_image.src =  pics[i+2*nmodel].src;
   document.abiaod4_image.src =  pics[i+3*nmodel].src;
...
function show2(i){
   ...
   document.abiaod1_image.src =  pics[ith].src;
   document.abiaod2_image.src =  pics[ith+nmodel].src;
   document.abiaod3_image.src =  pics[ith+2*nmodel].src;
   document.abiaod4_image.src =  pics[ith+3*nmodel].src;
}
...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=0; k<=23; k++) {
            vldhr=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/aqm."+area+".g16.aodc."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
            preload(filename);
         }
         for (k=0; k<=23; k++) {
            vldhr=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/aqm."+area+".g18.aodc."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
            preload(filename);
         }
         for (k=0; k<=23; k++) {
            vldhr=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/aqm."+area+".g1618.aodc."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
            preload(filename);
         }
         for (k=0; k<=23; k++) {
            vldhr=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/gefs."+area+".g1618.aodf."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
            preload(filename);
         }
         istatus=save_current_date(yr,mon,day);
         istatus=save_current_prod(area,qc);
         show(20);
      }
   }
}
...
function load_image_latest(){
   ...
   for (k=0; k<=23; k++) {
      vldhr=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/aqm."+area+".g16.aodc."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
      preload(filename);
   }
   for (k=0; k<=23; k++) {
      vldhr=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/aqm."+area+".g18.aodc."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
      preload(filename);
   }
   for (k=0; k<=23; k++) {
      vldhr=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/aqm."+area+".g1618.aodc."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
      preload(filename);
   }
   for (k=0; k<=23; k++) {
      vldhr=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/gefs."+area+".g1618.aodf."+dateStr+"."+vldhr+"."+prod+"."+qc+".png";
      preload(filename);
   }
