...
function anim(){
     ...
     document.highaod_image.src =  pics[i+1*nmodel].src;
     document.medaod_image.src =  pics[i+2*nmodel].src;
     document.lowaod_image.src =  pics[i+3*nmodel].src;
     if (i<=24){
        document.hms1_image.src  =  pics[4*nmodel].src;
     }
     else {
        document.hms1_image.src  =  pics[4*nmodel+1].src;
     }
...
function show2(i){
   ...
   document.highaod_image.src =  pics[ith+1*nmodel].src;
   document.medaod_image.src =  pics[ith+2*nmodel].src;
   document.lowaod_image.src =  pics[ith+3*nmodel].src;
   if (ith<=24){
      document.hms1_image.src  =  pics[4*nmodel].src;
   }
   else {
