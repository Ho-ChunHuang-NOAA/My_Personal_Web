...
function save_current_prod(exp1,exp2,exp3,cycle,area,prod,layer) {
   current_exp1=exp1;
   current_exp2=exp2;
   current_exp3=exp3;
   current_cyl=cycle;
...
function get_ftype_fire(run){
  ...
  function myWin(){
    newWin = open ("http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/html/cmaq_pm25.html", "displayWindow", "width=950,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
  ...
  function myWindow(frm){
    ...
    newWin = open ("http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/html/cmaq_pm25.html", "displayWindow", "width=800,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function anim(){
   ...
   document.cmaq2_pm_image.src =  pics[i+nmodel].src;
   document.cmaq3_pm_image.src =  pics[i+2*nmodel].src;
   document.highgaod_image.src =  pics[i+3*nmodel].src;
   document.medgaod_image.src  =  pics[i+4*nmodel].src;
   document.highvaod_image.src =  pics[i+5*nmodel].src;
   document.medvaod_image.src  =  pics[i+6*nmodel].src;
   if (i<=24){
      document.fire1_image.src  =  pics[7*nmodel].src;
   }
   else {
      document.fire1_image.src  =  pics[7*nmodel+1].src;
   }
   if (i<=24){
      document.fire2_image.src  =  pics[7*nmodel+2].src;
   }
   else {
      document.fire2_image.src  =  pics[7*nmodel+3].src;
   }
   document.fire3_image.src    =  pics[i+7*nmodel+4].src;
...
function show2(i){
   ...
   document.cmaq_pm_image.src  =  pics[ith].src;
   document.cmaq2_pm_image.src =  pics[ith+nmodel].src;
   document.cmaq3_pm_image.src =  pics[ith+2*nmodel].src;
   document.highgaod_image.src =  pics[ith+3*nmodel].src;
   document.medgaod_image.src  =  pics[ith+4*nmodel].src;
   document.highvaod_image.src =  pics[ith+5*nmodel].src;
   document.medvaod_image.src  =  pics[ith+6*nmodel].src;
   if (i<=24){
      document.fire1_image.src  =  pics[7*nmodel].src;
   }
   else {
   ...
   document.fire3_image.src    =  pics[ith+7*nmodel+4].src;
}
...
function load_image(frm){
   ...
   var fexp2_fire=get_ftype_fire(exp2);
   var fexp3_fire=get_ftype_fire(exp3);
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp1+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp2+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp3+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
            preload(filename);
         }
         obsfhd="aqm";
         for (k=1; k<=72; k++) {
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+".aod.high.png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+".aod.medium.png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".viirs."+newdate+"."+data+".aod.high.png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".viirs."+newdate+"."+data+".aod.medium.png";
            preload(filename);
         }
         obsfhd="aqm";
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/gbbepxfire."+area_hms+".prod."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/gbbepxfire."+area_hms+".prod."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/fireemisfire."+area_hms+".para6d."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/fireemisfire."+area_hms+".para6d."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/rrfs_fireemisfire."+area_hms+".v70fire."+dateStr+".t"+cycle+"z.location."+data+".k1.png";
            preload(filename);
         }
...
function load_image_latest(){
   ...
   for (k=1; k<=72; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp1+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
      preload(filename);
   }
   for (k=1; k<=72; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp2+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
      preload(filename);
   }
   for (k=1; k<=72; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp3+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
      preload(filename);
   }
         obsfhd="aqm";
         for (k=1; k<=72; k++) {
         ...
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/gbbepxfire."+area_hms+".prod."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/gbbepxfire."+area_hms+".prod."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/fireemisfire."+area_hms+".para6d."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/fireemisfire."+area_hms+".para6d."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/rrfs_fireemisfire."+area_hms+".v70fire."+dateStr+".t"+cycle+"z.location."+data+".k1.png";
            preload(filename);
         }
   show(13);
