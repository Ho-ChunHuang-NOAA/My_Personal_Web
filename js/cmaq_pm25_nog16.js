...
function anim(){
   ...
   if (i<=24){
      document.fire1_image.src  =  pics[5*nmodel].src;
   }
   else {
      document.fire1_image.src  =  pics[5*nmodel+1].src;
   }
   if (i<=24){
      document.fire2_image.src  =  pics[5*nmodel+2].src;
   }
   else {
      document.fire2_image.src  =  pics[5*nmodel+3].src;
   }
   if (i<=24){
      document.fire3_image.src  =  pics[5*nmodel+4].src;
   }
   else {
      document.fire3_image.src  =  pics[5*nmodel+5].src;
   }
