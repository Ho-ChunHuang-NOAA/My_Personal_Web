...
function anim(){
     ...
     document.medvaod_image.src =  pics[i+2*nmodel].src;
     if (i<=24){
...
function animation(){
     ...
     if(document.form2.timerBox.checked){
       document.hysplit_prod_image.src =  pics[i].src;
       document.highvaod_image.src =  pics[i+1*nmodel].src;
       document.medvaod_image.src =  pics[i+2*nmodel].src;
       if (i<=24){
          document.hms1_image.src  =  pics[3*nmodel].src;
       }
...
function show2(i){
   ...
   document.highvaod_image.src =  pics[ith+1*nmodel].src;
   document.medvaod_image.src =  pics[ith+2*nmodel].src;
   if (ith<=24){
      document.hms1_image.src  =  pics[3*nmodel].src;
   }
   else {
