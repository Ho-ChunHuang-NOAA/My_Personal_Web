...
function save_current_prod(cycle,area,prod,layer) {
   current_cyl=cycle;
   current_area=area;
   current_prod=prod;
   current_layer=layer;
...
function get_hms_area(area_in){
  ...
  function myWin(){
    newWin = open ("http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/html/hysplit.nesdis.html", "displayWindow", "width=950,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
  ...
  function myWindow(frm){
    ...
    newWin = open ("http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/html/hysplit.nesdis.html", "displayWindow", "width=800,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function anim(){
     ...
     document.cmaq_prod_image.src =  pics[i].src;
     document.cmaq_hms2cmaq_image.src =  pics[i+nmodel].src;
     document.nesdis_image.src  =  pics[i+2*nmodel].src;
     if (i<=24){
        document.hms1_image.src  =  pics[3*nmodel].src;
     }
     else {
        document.hms1_image.src  =  pics[3*nmodel+1].src;
     }
     if (i<=24){
        document.hms2_image.src  =  pics[3*nmodel+2].src;
     }
     else {
        document.hms2_image.src  =  pics[3*nmodel+3].src;
     }
...
function show2(i){
   ...
   document.cmaq_prod_image.src = pics[ith].src;
   document.cmaq_hms2cmaq_image.src = pics[ith+nmodel].src;
   document.nesdis_image.src  = pics[ith+2*nmodel].src;
   if (i<=24){
      document.hms1_image.src  =  pics[3*nmodel].src;
   }
   else {
...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+data+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+data+"_hms2cmaq.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+area+prod+layer+"_"+data+".png";
            preload(filename);
         }
         filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day1.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".hms2cmaq."+dateStr+".t"+cycle+"z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".hms2cmaq."+dateStr+".t"+cycle+"z.location.day1.k1.png";
         preload(filename);
         istatus=save_current_date(yr,mon,day);
         istatus=save_current_prod(cycle,area,prod,layer);
         show(11);
      }
   }
}
...
function load_image_latest(){
   ...
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+data+".png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+data+"_hms2cmaq.png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      itmp=cycle/1+k;
   ...
   filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day0.k1.png";
   preload(filename);
   filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day1.k1.png";
   preload(filename);
   filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".hms2cmaq."+dateStr+".t"+cycle+"z.location.day0.k1.png";
   preload(filename);
   filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".hms2cmaq."+dateStr+".t"+cycle+"z.location.day1.k1.png";
   preload(filename);
   show(11);
...
function load_imageP1(frm){
   ...
   if ( new_day > mcday ) {
      ...
      if ( new_julian_day < first_julian_day || new_julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+frm.ptyp.options[frm.ptyp.selectedIndex].value+data+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+frm.ptyp.options[frm.ptyp.selectedIndex].value+data+"_hms2cmaq.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
