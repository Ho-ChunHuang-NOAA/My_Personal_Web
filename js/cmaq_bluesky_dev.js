...
function anim(){
     ...
     document.cmaq_dev_image.src =  pics[i+nmodel].src;
...
function show2(i){
   ...
   document.cmaq_dev_image.src = pics[ith+nmodel].src;
...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+data+"_dev.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+".aod.k1.png";
            preload(filename);
         }
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day1.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".para."+dateStr+".t"+cycle+"z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".para."+dateStr+".t"+cycle+"z.location.day1.k1.png";
         preload(filename);
...
function load_image_latest(){
   ...
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+data+"_dev.png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      itmp=cycle/1+k;
   ...
   filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day0.k1.png";
   preload(filename);
   filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".prod."+dateStr+".t"+cycle+"z.location.day1.k1.png";
   preload(filename);
   filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".para."+dateStr+".t"+cycle+"z.location.day0.k1.png";
   preload(filename);
   filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaqhmsfire."+area_hms+".para."+dateStr+".t"+cycle+"z.location.day1.k1.png";
   preload(filename);
   show(11);
...
function load_imageP1(frm){
   ...
   if ( new_day > mcday ) {
      ...
      if ( new_julian_day < first_julian_day || new_julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/cmaq"+area+prod+layer+"_"+frm.ptyp.options[frm.ptyp.selectedIndex].value+data+"_dev.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
