...
function anim(){
   ...
   document.gefs1_pm_image.src =  pics[i+2*nmodel].src;
   document.highgaod_image.src =  pics[i+3*nmodel].src;
   document.highvaod_image.src =  pics[i+4*nmodel].src;
   document.cmaq_aod_image.src =  pics[i+5*nmodel].src;
   document.gefs_aod_image.src =  pics[i+6*nmodel].src;
   document.fire1_image.src    =  pics[i+7*nmodel].src;
...
function show2(i){
   ...
   document.gefs1_pm_image.src =  pics[ith+2*nmodel].src;
   document.highgaod_image.src =  pics[ith+3*nmodel].src;
   document.highvaod_image.src =  pics[ith+4*nmodel].src;
   document.cmaq_aod_image.src =  pics[ith+5*nmodel].src;
   document.gefs_aod_image.src =  pics[ith+6*nmodel].src;
   document.fire1_image.src    =  pics[ith+7*nmodel].src;
}
...
function load_image(frm){
   ...
   var gefsarea=get_gefs_area(area);
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/gc_wmb/parthab/For_HoChun/"+dateStr+"/gefs."+gefsarea+"."+dateStr+".t"+cycle+"z."+prod+".sfc.f0"+data+".png";
            preload(filename);
         }
         obsfhd="aqm";
         for (k=1; k<=72; k++) {
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g18.aodc."+newdate+"."+data+".aod.high.png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            itmp=cycle/1+k;
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+".prod."+dateStr+".t"+cycle+"z."+data+".aod."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/gc_wmb/parthab/For_HoChun/"+dateStr+"/gefs."+gefsarea+"."+dateStr+".t"+cycle+"z.aod.k1.f0"+data+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
...
function load_image_latest(){
   ...
   for (k=1; k<=72; k++) {
      ...
      preload(filename);
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+".prod."+dateStr+".t"+cycle+"z."+data+".aod."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
