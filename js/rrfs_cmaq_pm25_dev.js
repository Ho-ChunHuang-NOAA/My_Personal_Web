   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=72; k++) {
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g18.aodc."+newdate+"."+data+".aod.high.png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            itmp=cycle/1+k;
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+".prod."+dateStr+".t"+cycle+"z."+data+".aod."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
...
function load_image_latest(){
   ...
   for (k=1; k<=72; k++) {
      ...
      preload(filename);
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+".prod."+dateStr+".t"+cycle+"z."+data+".aod."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
