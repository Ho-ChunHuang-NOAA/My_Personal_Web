...
function save_current_prod(exp1,exp2,exp3,cycle,area,prod) {
   current_exp1=exp1;
   current_exp2=exp2;
   current_exp3=exp3;
   current_cyl=cycle;
...
function get_ftype_fire(run){
  ...
  function myWin(){
    newWin = open ("http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/html/cmaq_pm25_max.html", "displayWindow", "width=950,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
  ...
  function myWindow(frm){
    ...
    newWin = open ("http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/html/cmaq_pm25_max.html", "displayWindow", "width=800,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function anim(){
   ...
   document.cmaq1_pm_image.src =  pics[i].src;
...
function show2(i){
   ...
   document.cmaq1_pm_image.src =  pics[latest_ith].src;
   document.cmaq2_pm_image.src =  pics[latest_ith+nmodel].src;
   document.cmaq3_pm_image.src =  pics[latest_ith+2*nmodel].src;
...
function show(i){
   ith=i;
   document.cmaq1_pm_image.src =  pics[ith].src;
...
function prev(){
   ith=ith-1;
   if(ith < 0) ith=0;
   document.cmaq1_pm_image.src =  pics[ithth].src;
   document.cmaq2_pm_image.src =  pics[ith+nmodel].src;
   document.cmaq3_pm_image.src =  pics[ith+2*nmodel].src;
   document.fire1_image.src    =  pics[ith+3*nmodel].src;
   document.fire2_image.src    =  pics[ith+4*nmodel].src;
...
function load_image(frm){
   ...
   var fireexp2="fireemisfire";
   var fireexp3="fireemisfire";
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp1+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
            preload(filename);
         }
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp2+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
            preload(filename);
         }
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp3+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/"+fireexp1+"."+area_hms+".prod."+dateStr+".t06z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/"+fireexp2+"."+area_hms+".para6d."+dateStr+".t06z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/"+fireexp3+"."+area_hms+".prod."+dateStr+".t06z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/dustemis."+area+".prod."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=1; k<=nmodel; k++) {
            data=Num2Chr(k);
         ...
         istatus=save_current_prod(exp1,exp2,exp3,cycle,area,prod);
         show(0);
      }
   }
}
...
function load_image_latest(){
   ...
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp1+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
      preload(filename);
   }
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp2+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
      preload(filename);
   }
   for (k=1; k<=nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp3+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
      preload(filename);
   }
   for (k=0; k<nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/"+fireexp1+"."+area_hms+".prod."+dateStr+".t06z.location.day"+k+".k1.png";
      preload(filename);
   }
   for (k=0; k<nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/"+fireexp2+"."+area_hms+".para6d."+dateStr+".t06z.location.day"+k+".k1.png";
      preload(filename);
   }
   for (k=0; k<nmodel; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/"+fireexp3+"."+area_hms+".prod."+dateStr+".t06z.location.day"+k+".k1.png";
      preload(filename);
   }
   for (k=1; k<=nmodel; k++) {
       data=Num2Chr(k);
       filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/dustemis."+area+".prod."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
       preload(filename);
   }
   for (k=1; k<=nmodel; k++) {
       data=Num2Chr(k);
