...
//
//  var num = 5.56789;    num name need to be consistent with following examples
//  number to textc var n = num.toString();
//  covert num to 2 decimal number var n = num.toFixed(2);   num.toFixed(); is no decimal
//
...
function save_current_prod(exp1,exp2,cycle,area,prod,layer) {
   current_exp1=exp1;
   current_exp2=exp2;
   current_cyl=cycle;
   current_area=area;
...
function get_hms_area(area_in){
  ...
  function myWin(){
    newWin = open ("http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/html/hysplit_emc_tcomp.html", "displayWindow", "width=950,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
  ...
  function myWindow(frm){
    ...
    newWin = open ("http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/html/hysplit_emc_tcomp.html", "displayWindow", "width=800,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function anim(){
     ...
     document.hysplit_exp1_image.src =  pics[i].src;
     document.hysplit_exp2_image.src =  pics[i+nmodel].src;
     document.diff_image.src = pics[i+2*nmodel].src;
     document.highaod_image.src =  pics[i+3*nmodel].src;
     document.medaod_image.src =  pics[i+4*nmodel].src;
     document.lowaod_image.src =  pics[i+5*nmodel].src;
     if (i<=24){
        document.hms1_image.src  =  pics[6*nmodel].src;
     }
     else {
        document.hms1_image.src  =  pics[6*nmodel+1].src;
     }
     if (i<=24){
        document.hms2_image.src  =  pics[6*nmodel+2].src;
     }
     else {
        document.hms2_image.src  =  pics[6*nmodel+3].src;
     }
...
function show2(i){
   ...
   document.hysplit_exp1_image.src = pics[ith].src;
   document.hysplit_exp2_image.src = pics[ith+nmodel].src;
   document.diff_image.src  = pics[ith+2*nmodel].src;
   document.highaod_image.src =  pics[ith+3*nmodel].src;
   document.medaod_image.src =  pics[ith+4*nmodel].src;
   document.lowaod_image.src =  pics[ith+5*nmodel].src;
   if (ith<=24){
      document.hms1_image.src  =  pics[6*nmodel].src;
   }
   else {
...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp1+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+"m"+exp1+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.high.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.medium.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.low.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp1+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp2+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         istatus=save_current_date(yr,mon,day);
         istatus=save_current_prod(exp1,exp2,cycle,area,prod,layer);
         show(11);
      }
   }
}
...
function load_image_latest(){
   ...
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp1+".png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+".png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+"m"+exp1+".png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      itmp=cycle/1+k;
   ...
   for (k=1; k<=48; k++) {
      ...
      preload(filename);
         ...
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+exp1+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+exp2+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
   show(11);
...
function load_imageP1(frm){
   ...
   if ( new_day > mcday ) {
      ...
      chr_mon=Num2Chr(new_mon);
      chr_day=Num2Chr(new_day);
      alert("McDay Figure for date selected   "+chr_yr+"  "+chr_mon+"  "+chr_day+"   is not available");
   }
   else {
      ...
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.low.png";
         ...
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp1+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp2+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         istatus=save_current_date(chr_yr,chr_mon,chr_day);
         istatus=save_current_prod(exp1,exp2,cycle,area,prod,layer);
