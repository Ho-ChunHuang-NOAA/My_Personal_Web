...
function get_hms_area(area_in){
  ...
  function myWin(){
    newWin = open ("http://www.emc.ncep.noaa.gov/mmb/hchuang/web/html/hysplit_emc_tcomp.html", "displayWindow", "width=950,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
  ...
  function myWindow(frm){
    ...
    newWin = open ("http://www.emc.ncep.noaa.gov/mmb/hchuang/web/html/hysplit_emc_tcomp.html", "displayWindow", "width=800,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp1+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+"m"+exp1+".png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.high.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.medium.png";
            preload(filename);
         }
         for (k=1; k<=48; k++) {
            itmp=cycle/1+k;
            ...
            chr_oyr=Num2Chr(obs_yr);
            data=itmp;
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.low.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp1+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp2+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
...
function load_image_latest(){
   ...
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp1+".png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+".png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hysplit"+area+prod+layer+"_"+data+"_"+exp2+"m"+exp1+".png";
      preload(filename);
   }
   for (k=1; k<=48; k++) {
      itmp=cycle/1+k;
   ...
   for (k=1; k<=48; k++) {
      ...
      preload(filename);
         ...
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+exp1+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+exp2+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
   show(11);
...
function load_imageP1(frm){
   ...
   if ( new_day > mcday ) {
      ...
      filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_oyr+"/"+newdate+"/"+obsfhd+"."+area+".g16."+newdate+"."+data+"."+aodtype+"aod.low.png";
         ...
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp1+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         for (k=0; k<=1; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/mmb/hchuang/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area_hms+"."+hmsexp2+"."+dateStr+".t"+cycle+"z.location.day"+k+".k1.png";
            preload(filename);
         }
         istatus=save_current_date(chr_yr,chr_mon,chr_day);
         istatus=save_current_prod(exp1,exp2,cycle,area,prod,layer);
