...
function get_current_prod(){
  ...
  function myWin(){
    newWin = open ("http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/html/hysplit_hms.html", "displayWindow", "width=950,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
  ...
  function myWindow(frm){
    ...
    newWin = open ("http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/html/hysplit_hms.html", "displayWindow", "width=800,height=800,menubar=yes,resizable=yes,scrollbars=yes,toolbar=yes,location=yes,status=yes");
  }
...
function show2(i){
   ...
   document.fcst_fire_image.src = pics[ith].src;
}
...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=0; k<=2; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area+"."+exp+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
            preload(filename);
         }
...
function load_image_latest(){
   ...
   for (k=0; k<=2; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/hmsfire."+area+"."+exp+"."+dateStr+".t"+cycle+"z."+prod+".day"+k+".k1.png";
      preload(filename);
   }
   show(0);
