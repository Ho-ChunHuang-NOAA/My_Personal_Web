...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         if ( exp == "para11h" || exp == "para92h" || exp == "para93h" || exp == "para94h" || exp == "para97h" || exp == "para98h" ) {
            fireexp1="para82h";
         }
         else {
            fireexp1=exp;
         ...
         if ( emcexp == "para11h" || emcexp == "para92h" || emcexp == "para93h" || emcexp == "para94h" || emcexp == "para97h" || emcexp == "para98h" ) {
            fireexp2="para82h";
         }
         else {
               fireexp2=emcexp;
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"-"+exp+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
            preload(filename);
         }
         obsfhd="aqm";
         for (k=1; k<=72; k++) {
...
function load_image_latest(){
   ...
   for (k=1; k<=72; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov/regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"-"+exp+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
      preload(filename);
   }
         obsfhd="aqm";
         for (k=1; k<=72; k++) {
