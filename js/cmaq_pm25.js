...
function load_image(frm){
   ...
   if ( day > mcday ) {
      ...
      if ( julian_day < first_julian_day || julian_day > latest_julian_day ) {
         ...
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
            preload(filename);
         }
         for (k=1; k<=72; k++) {
            data=Num2Chr(k);
            filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+diffexp2+"-"+diffexp1+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
            preload(filename);
         }
         obsfhd="aqm";
         for (k=1; k<=72; k++) {
         ...
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/"+fexp_fire+"."+area_hms+"."+fireexp1+"."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
         ...
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/"+femcexp_fire+"."+area_hms+"."+fireexp2+"."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/"+femcexp2_fire+"."+area_hms+".para6d."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+yr+"/"+dateStr+"/t06z/"+femcexp2_fire+"."+area_hms+".para6d."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
...
function load_image_latest(){
   ...
   for (k=1; k<=72; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+exp+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
      preload(filename);
   }
   for (k=1; k<=72; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+emcexp+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
      preload(filename);
   }
   for (k=1; k<=72; k++) {
      data=Num2Chr(k);
      filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t"+cycle+"z/aqm."+area+"."+diffexp2+"-"+diffexp1+"."+dateStr+".t"+cycle+"z."+data+"."+prod+"."+layer+".png";
      preload(filename);
   }
         obsfhd="aqm";
         for (k=1; k<=72; k++) {
         ...
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/"+fexp_fire+"."+area_hms+"."+fireexp1+"."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         ...
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/"+femcexp_fire+"."+area_hms+"."+fireexp2+"."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         ...
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/"+femcexp2_fire+"."+area_hms+".para6d."+dateStr+".t06z.location.day0.k1.png";
         preload(filename);
         filename="http://www.emc.ncep.noaa.gov//regional/restricted/aqm/web/fig/"+chr_yr+"/"+dateStr+"/t06z/"+femcexp2_fire+"."+area_hms+".para6d."+dateStr+".t06z.location.day1.k1.png";
         preload(filename);
   if ( cycle == "12" ) {
       show(8);
   }
